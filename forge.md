...
│   └── commands/
│       └── pack.rs     # Pack-and-Go system implementation
...
# Unstage staged files (reverse of stage, without deleting)
forge unstage init.lua

# Purge all dotfile records for a folder, restoring originals
forge purge

# Check pack manifest integrity
...
*Note: Interactive mode is on the roadmap for the v1.0.0 release.*
